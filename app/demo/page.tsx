...
const demoAccounts = [
  ...
  },
  {
    ...
    role: 'member',
    roleLabel: 'Membre',
    description: 'Membre de HAROFEMA. Accès par carte aux comptes d\'exploitation, consultation des fiches techniques gratuitement.',
    cooperative: 'HAROFEMA',
    redirectTo: '/dashboard',
    icon: User,
  ...
  },
  {
    ...
    role: 'guest',
    roleLabel: 'Invité',
    description: 'Non-membre. Peut consulter les comptes d\'exploitation publics mais doit payer 500 FCFA par fiche technique.',
    cooperative: 'Aucune',
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[
                      ...
                      ['Panneau admin', '✓ (tout)', '✗', '✗', '✗'],
                      ['Comptes d\'exploitation', '✓', '✓', '✓', '✓ (lecture)'],
                      ['Membres', '✓ (tout)', '✓ (propre)', '✓', '✗'],
