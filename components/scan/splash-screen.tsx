...
export function SplashScreen() {
  ...
  return (
    ...
    >
      ...
      <svg
        aria-hidden="true"
        style={{ position: 'absolute', top: 0, left: 0, width: 180, height: 180, opacity: 0.55 }}
        viewBox="0 0 180 180"
      >
      ...
      <svg
        ...
        style={{
          ...
          width: 240,
          height: 240,
          animation: 'splashSpinR 12s linear infinite',
          opacity: 0.18,
        }}
        viewBox="0 0 240 240"
      >
      ...
      <div
        style={{
          ...
          transition:
            'opacity .5s cubic-bezier(.2,.7,.2,1), transform .5s cubic-bezier(.2,.7,.2,1)',
        }}
      >
        ...
        <div
          style={{
            ...
            justifyContent: 'center',
            boxShadow:
              '0 0 0 1px rgba(77,255,160,.35), 0 32px 80px -20px rgba(0,0,0,.8), 0 0 60px -10px rgba(30,215,96,.25)',
          }}
        >
          <Image
            src="/logo.png"
