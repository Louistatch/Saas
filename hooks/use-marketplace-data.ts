  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      const { data: result, error: rpcError } = await supabase.rpc('search_marketplace', {
        ...
        filter_min_price: filters.min_price ? Number.parseFloat(filters.min_price) : null,
        filter_max_price: filters.max_price ? Number.parseFloat(filters.max_price) : null,
